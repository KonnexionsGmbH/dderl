...
exec &> >(tee -i docker/run_create_image_dderl_dev.log)
sleep .1

# ------------------------------------------------------------------------------
#
# run_create_image_dderl_dev.sh: Create a project specific docker image based on Debian.
#
# ------------------------------------------------------------------------------

export REPOSITORY=dderl_dev
