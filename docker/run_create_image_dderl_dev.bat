...
rem ----------------------------------------------------------------------------
rem
rem run_create_image_dderl_dev.bat: Create a project specific docker image based on Debian.
rem
rem ----------------------------------------------------------------------------

setlocal EnableDelayedExpansion

set REPOSITORY=dderl_dev

echo.
echo Skript %0 is now running
echo.
echo You can find the run log in the file run_create_image_dderl_dev.log
echo.
echo Please wait ...
echo.

> docker\run_create_image_dderl_dev.log 2>&1 (
